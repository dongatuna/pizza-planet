<template>
    <form action="">
        ...
        <div class="form-group row">
            <label for="name" class="cols-sm-3">Name:</label>
            <div class="col-sm-9">
        ...
        <div class="form-group row">
            <label for="name" class="cols-sm-3">Description:</label>
            <div class="col-sm-9">
        ...
        <div class="form-group row">
            <label for="name" class="cols-sm-3">Size ("):</label>
            <div class="col-sm-9">
        ...
        <div class="form-group row">
            <label for="name" class="cols-sm-3">Price:</label>
            <div class="col-sm-9">
        ...
        <div class= "form-group row">
            <button type="button" class="btn btn-success btn-block" v-on:click="addMenuItem">Add</button>
        </div>
        ...
        data(){
            return{
                newPizza:{                    
                    ...
                    'description': 'Eg. A delicious tomato based pizza topped with mozzarella, ham and pineapple',
